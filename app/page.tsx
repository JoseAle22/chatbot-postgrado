...
import { Button } from "C:/Users/USUARIO/Documents/Universidad/Tesis2/chatbot-postgrado/src/components/ui/button.tsx"
import { Card, CardContent } from "C:/Users/USUARIO/Documents/Universidad/Tesis2/chatbot-postgrado/src/components/ui/card.tsx"
      ...
      <div className="bg-amber-600 text-white py-2 px-4 hidden md:block">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <a href="https://www.facebook.com/ujap.edu.ve" target="_blank" rel="noopener noreferrer">
              <Facebook className="h-5 w-5 hover:text-amber-200 transition-colors" />
            </a>
            <a href="https://twitter.com/ujap" target="_blank" rel="noopener noreferrer">
              <Twitter className="h-5 w-5 hover:text-amber-200 transition-colors" />
            </a>
            <a href="https://www.instagram.com/ujap.edu.ve/" target="_blank" rel="noopener noreferrer">
              <Instagram className="h-5 w-5 hover:text-amber-200 transition-colors" />
            </a>
          </div>
        </div>
      </div>
